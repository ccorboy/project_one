...
3. Given the low to moderate amount of missing data, it was decided to fill in any continuous variables with the mean of that row and to drop any missing data from categorical features.  
